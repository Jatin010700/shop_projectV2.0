  ...
  return (
    <>
      ...
      <div className="min-w-screen min-h-screen flex items-center justify-center">
        <div className="w-full bg-dark px-5 py-16 md:py-24 text-gray-800">
          <div className="w-full max-w-6xl mx-auto">
            ...
            <div className="-mx-3 md:flex items-start">
              <div className="px-3 md:w-1/3">
                <div className="w-full mx-auto rounded-lg bg-RED p-5 text-gray-800 font-light mb-6">
              ...
              <div className="px-3 md:w-1/3">
                <div className="w-full mx-auto rounded-lg text-dark bg-white p-5 text-gray-800 font-light mb-6">
                  <div className="w-full flex mb-4 items-center">
                    <div className="overflow-hidden rounded-full w-10 h-10 bg-gray-50">
